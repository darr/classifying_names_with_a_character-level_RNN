...
# Modified date : 2019-02-19 11:10
# Author : DARREN
# Describe : not set
...
config["early_stop_epoch_limit"] = 10
...
config["learn_rate"] = 0.005 # If you set this too high, it might explode. If too low, it might not learn
config["momentum"] = 0.9
config["all_letters"] = string.ascii_letters + " .,;'"
config["n_letters"] = len(config["all_letters"])
config["n_hidden"] = 128
